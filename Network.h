...
// -----------------------------------------------
#define   servername "BanDuke"  // Set your server's logical name here e.g. if 'myserver' then address is http://myserver.local/
...
const char ssid_1[]     = "BBOX-Ewald";
const char password_1[] = "AC6D34FFF496A1F46E35AE251C97C1";
